 ...
 */
export interface AcreQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: AcreParams;
}

export interface AcreWhatis {
  index?: string;
  addr?: string;
  owner?: string;
  buyer?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/acre/acre/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<AcreQueryParamsResponse, RpcStatus>({
      path: `/acre/acre/params`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryWhatisAll = (
    ...
    this.request<AcreQueryAllWhatisResponse, RpcStatus>({
      path: `/acre/acre/whatis`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/acre/acre/whatis/{index}
   */
  queryWhatis = (index: string, params: RequestParams = {}) =>
    this.request<AcreQueryGetWhatisResponse, RpcStatus>({
      path: `/acre/acre/whatis/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
